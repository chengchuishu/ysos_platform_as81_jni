/**
 *@file audiocaptureextcallback.h
 *@brief the audio capture ext call back
 *@version 1.0
 *@author l.j..
...
#ifndef AUDIOCAPTUREEXT_CALLBACK_H_
#define AUDIOCAPTUREEXT_CALLBACK_H_
...
*/
class YSOS_EXPORT AudioCaptureExtCallback : public BaseThreadModuleCallbackImpl {
  DECLARE_CREATEINSTANCE(AudioCaptureExtCallback);
  DISALLOW_COPY_AND_ASSIGN(AudioCaptureExtCallback);
  DECLARE_PROTECT_CONSTRUCTOR(AudioCaptureExtCallback);

 public:
  virtual ~AudioCaptureExtCallback(void);
...
#endif///< AUDIOCAPTUREEXT_CALLBACK_H_    //NOLINT
