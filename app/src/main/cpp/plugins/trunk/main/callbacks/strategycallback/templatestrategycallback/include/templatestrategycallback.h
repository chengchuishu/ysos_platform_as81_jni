...
*/
    ...
    private:
        ...
        */
        ...
        int ParserNotifyEventInfo(BufferInterfacePtr input_buffer,  std::string &event_name);
        int NotifyEventDoAction(std::string event_name, CallbackInterface *context);
