/**
 *@file doconfigcallback.h
 *@brief doconfig call back
 *@version 1.0
 *@author l.j..
...
#ifndef DO_CONFIG_CALLBACK_H_
#define DO_CONFIG_CALLBACK_H_
...
/**
 *@brief  配置模块回调层 //NOLINT
*/
class YSOS_EXPORT DoconfigCallback : public BaseThreadModuleCallbackImpl {
  DECLARE_CREATEINSTANCE(DoconfigCallback);
  DISALLOW_COPY_AND_ASSIGN(DoconfigCallback);
  DECLARE_PROTECT_CONSTRUCTOR(DoconfigCallback);

 public:
  virtual ~DoconfigCallback(void);
  /**
...
#endif///< DO_CONFIG_CALLBACK_H_    //NOLINT