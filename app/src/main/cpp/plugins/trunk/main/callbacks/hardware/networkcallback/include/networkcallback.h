 ...
 *@brief  模块回调层 //NOLINT
*/
class YSOS_EXPORT NetworkCallback : public BaseThreadModuleCallbackImpl {
  DECLARE_CREATEINSTANCE(NetworkCallback);
  DISALLOW_COPY_AND_ASSIGN(NetworkCallback);
  DECLARE_PROTECT_CONSTRUCTOR(NetworkCallback);
...
#endif  ///< NETWORK_CALLBACK_H_    //NOLINT