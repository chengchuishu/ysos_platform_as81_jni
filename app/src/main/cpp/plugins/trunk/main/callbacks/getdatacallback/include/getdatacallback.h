...
#ifndef YSOS_PLUGIN_GET_DATA_CALLBACK_H_  //NOLINT
#define YSOS_PLUGIN_GET_DATA_CALLBACK_H_  //NOLINT
...
namespace ysos {  
  ...
  */
class YSOS_EXPORT GetDataCallback : public  BaseThreadModuleCallbackImpl{
DECLARE_CREATEINSTANCE(GetDataCallback);
DISALLOW_COPY_AND_ASSIGN(GetDataCallback);
DECLARE_PROTECT_CONSTRUCTOR(GetDataCallback);
...
#endif    //  YSOS_PLUGIN_GET_DATA_CALLBACK_H_  //NOLINT