 ...
 *@brief  模块回调层 //NOLINT
*/
class YSOS_EXPORT MQttCallback : public BaseThreadModuleCallbackImpl {
  DECLARE_CREATEINSTANCE(MQttCallback);
  DISALLOW_COPY_AND_ASSIGN(MQttCallback);
  DECLARE_PROTECT_CONSTRUCTOR(MQttCallback);

 public:
  virtual ~MQttCallback(void);
  /**
