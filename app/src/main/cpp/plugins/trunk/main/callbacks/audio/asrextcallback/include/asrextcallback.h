/**
 *@file asrextcallback.h
 *@brief the asr ext call back
 *@version 1.0
 *@author l.j..
...
#ifndef ASREXT_CALLBACK_H_
#define ASREXT_CALLBACK_H_
...
*/
class YSOS_EXPORT AsrExtCallback : public BaseModuleThreadCallbackImpl {
  DECLARE_CREATEINSTANCE(AsrExtCallback);
  DISALLOW_COPY_AND_ASSIGN(AsrExtCallback);
  DECLARE_PROTECT_CONSTRUCTOR(AsrExtCallback);

 public:
  virtual ~AsrExtCallback(void);
...
#endif///< ASREXT_CALLBACK_H_    //NOLINT
