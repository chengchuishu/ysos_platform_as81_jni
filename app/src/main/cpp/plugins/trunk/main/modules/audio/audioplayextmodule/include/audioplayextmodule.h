/**
 *@file audioplayextmodule.h
 *@brief audio play ext module interface
 *@version 1.0
 *@author l.j..
...
#ifndef AUDIOPLAYEXT_MODULE_H_
#define AUDIOPLAYEXT_MODULE_H_
...
*/
class YSOS_EXPORT AudioPlayExtModule : public BaseModuleImpl {
  DECLARE_CREATEINSTANCE(AudioPlayExtModule);
  DISALLOW_COPY_AND_ASSIGN(AudioPlayExtModule);
  DECLARE_PROTECT_CONSTRUCTOR(AudioPlayExtModule);

 public:
  virtual ~AudioPlayExtModule(void);
  /**
...
#endif    ///AUDIOPLAYEXT_MODULE_H_    //NOLINT