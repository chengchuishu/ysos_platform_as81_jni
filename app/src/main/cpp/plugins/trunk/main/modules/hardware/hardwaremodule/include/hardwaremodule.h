...
#ifndef HARDWARE_MODULE_H_
#define HARDWARE_MODULE_H_
...
/**
 *@brief  硬件自检模块逻辑控制层 //NOLINT
*/
class YSOS_EXPORT HardwareModule : public BaseThreadModuleImpl {
  DECLARE_CREATEINSTANCE(HardwareModule);
  DISALLOW_COPY_AND_ASSIGN(HardwareModule);
  DECLARE_PROTECT_CONSTRUCTOR(HardwareModule);

 public:
  virtual ~HardwareModule(void);
  /**
...
#endif    ///HARDWARE_MODULE_H_    //NOLINT