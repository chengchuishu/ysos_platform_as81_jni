...
/**
 *@brief  网络检查模块逻辑控制层 //NOLINT
*/
class YSOS_EXPORT NetworkModule : public BaseThreadModuleImpl {
  DECLARE_CREATEINSTANCE(NetworkModule);
  DISALLOW_COPY_AND_ASSIGN(NetworkModule);
  DECLARE_PROTECT_CONSTRUCTOR(NetworkModule);
...
#endif    ///NETWORK_MODULE_H_    //NOLINT