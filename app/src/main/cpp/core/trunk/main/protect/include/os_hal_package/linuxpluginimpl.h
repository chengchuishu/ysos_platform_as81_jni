/*
# LinuxPluginImpl.h
# Definition of LinuxPluginImpl
# Created on: 2016-04-25 13:59:20
# Original author: dhongqian
# Copyright (c) 2016 YunShen Technology. All rights reserved.
# 
*/
#ifndef YSOS_OHP_LINUX_PLUGIN_H_                                                 //NOLINT
#define YSOS_OHP_LINUX_PLUGIN_H_                                                 //NOLINT
...
namespace ysos {
   ...
   */
class YSOS_EXPORT LinuxPluginImpl: public PluginInterface, public BaseInterfaceImpl{
  DECLARE_CREATEINSTANCE(LinuxPluginImpl);
  DISALLOW_COPY_AND_ASSIGN(LinuxPluginImpl);
  DECLARE_PROTECT_CONSTRUCTOR(LinuxPluginImpl);
...
typedef boost::shared_ptr<LinuxPluginImpl> LinuxPluginPtr;
}
#endif  ///< YSOS_OHP_LINUX_PLUGIN_H_ NOLINT