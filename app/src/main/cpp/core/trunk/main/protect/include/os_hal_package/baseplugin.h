/*
# BasePlugin.h
# Definition of BasePlugin
# Created on: 2016-04-25 13:59:20
# Original author: dhongqian
# Copyright (c) 2016 YunShen Technology. All rights reserved.
# 
*/
#ifndef YSOS_OHP_BASE_PLUGIN_H_                                                 //NOLINT
#define YSOS_OHP_BASE_PLUGIN_H_                                                 //NOLINT
...
namespace ysos {
  ...
  /**
   *@brief BasePlugin是系统内加载插件的统一接口抽象基类，根据不同平台，
       调用不同的平台插件实现类，可用于加载Module、Callback、Protocol等各种平台插件
   */
class YSOS_EXPORT BasePlugin: public PluginInterface, public BaseInterfaceImpl{
  DECLARE_CREATEINSTANCE(BasePlugin);
  DISALLOW_COPY_AND_ASSIGN(BasePlugin);
  DECLARE_PROTECT_CONSTRUCTOR(BasePlugin);
...
protected:
  PluginInterfacePtr        plugin_impl_;  ///<  实际的plugin加载对象 //  NOLINT
};

typedef boost::shared_ptr<BasePlugin> BasePluginPtr;
}
#endif  ///< YSOS_OHP_BASE_PLUGIN_H_ NOLINT